              ...
              {books &&
                books.map((book) => (
                  <Card
                    ...
                    onClick={() => {
                      handleCardClick(
                        book.annotations.map((annotation) => annotation.text)
                      );
                  ...
                  {selectedAnnotations.map((annotation, index) => (
                    <>
                      <div className="highlight-box">
                        <div className="h-75	" key={index}>
                          <p className="h-full overflow-y-auto">{annotation}</p>
                        </div>
                        <div className="  gap-2.5 w-full text-right flex justify-end">
                          <div>Burn</div>
